...
public class BusinessViewImpl implements BusinessView {
    ...
    public void listBusinessAll() {
        ...
        System.out.println("商家编号\t\t商家名称\t\t商家地址\t\t起送费\t\t配送费");
        for (Business b : list) {
    ...
    public void showStarPrice() {
        BusinessDao dao = new BusinessDaoImpl();
        List<Business> list = dao.listStarPrice(null, null);
        System.out.println("商家编号\t\t商家名称\t\t商家介绍\t\t起送费");
        for (Business b : list) {
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName()  + "\t" + b.getBusinessExplain() + "\t" + b.getStarPrice());

        }
    }
    public void showStarPrice2() {
        BusinessDao dao = new BusinessDaoImpl();
        List<Business> list = dao.listStarPrice2(null, null);
        System.out.println("商家编号\t\t商家名称\t\t商家介绍\t\t起送费");
        for (Business b : list) {
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName()  + "\t" + b.getBusinessExplain() + "\t" + b.getStarPrice());
    ...
    public void showDeliveryPrice() {
        BusinessDao dao = new BusinessDaoImpl();
        List<Business> list = dao.listDeliveryPrice(null, null);
        System.out.println("商家编号\t\t商家名称\t\t商家介绍\t\t配送费");
        for (Business b : list) {
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName()  + "\t" + b.getBusinessExplain() + "\t" + b.getDeliveryPrice());

        }
    }
    public void showDeliveryPrice2() {
        BusinessDao dao = new BusinessDaoImpl();
        List<Business> list = dao.listDeliveryPrice2(null, null);
        System.out.println("商家编号\t\t商家名称\t\t商家介绍\t\t配送费");
        for (Business b : list) {
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName()  + "\t" + b.getBusinessExplain() + "\t" + b.getDeliveryPrice());
    ...
    public void checkDeliveryPrice(){
        int dp;
        System.out.println("请输入配送费(多少元以下)：");
        dp= input.nextInt();
        BusinessDao dao = new BusinessDaoImpl();
        List<Business> list = dao.checkDeliveryPrice(dp);
        System.out.println("商家编号\t\t商家名称\t\t商家地址\t\t起送费\t\t配送费");
        for (Business b : list) {
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName() + "\t" + b.getBusinessAddress() + "\t" + b.getBusinessExplain() + "\t" + b.getStarPrice() + "\t" + b.getDeliveryPrice());
    ...
    public void checkStarPrice(){
        int dp;
        System.out.println("请输入起送费(多少元以上)：");
        dp= input.nextInt();
        BusinessDao dao = new BusinessDaoImpl();
        List<Business> list = dao.checkStarPrice(dp);
        System.out.println("商家编号\t\t商家名称\t\t商家地址\t\t起送费\t\t配送费");
        for (Business b : list) {
            System.out.println(b.getBusinessId() + "\t" + b.getBusinessName() + "\t" + b.getBusinessAddress() + "\t" + b.getBusinessExplain() + "\t" + b.getStarPrice() + "\t" + b.getDeliveryPrice());
